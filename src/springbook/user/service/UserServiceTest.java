...
public class UserServiceTest {
	...
	public void setUp() {
		users = Arrays.asList(
			new User("bumjin", "박범진", "p1", Level.BASIC, MIN_LOGOUT_FOR_SILVER-1, 0, "bumjin@ksug.org"),
			new User("joytouch", "강명성", "p2", Level.BASIC, MIN_LOGOUT_FOR_SILVER, 0, "joytouch@ksug.org"),
	...
	public void upgradeAllOrNothing() throws Exception {
		...
		txHandler.setTransacntionManager(transactionManager);
